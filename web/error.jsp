        ...
        <div class="container-fluid ">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/TempSectionList">我的专题</a></li>
...
<script type="text/javascript">
    ...
    function countDown(){
        ...
        if (t<=0) {
            ...
            location.href="${pageContext.request.contextPath}/Zong-index.jsp";
