                    ...
                    <div class="comments panel">
                        <header>
                            <div class="reply-form">
                                <form class="form-horizontal jeesns_form" action="/back/backPost.do?postID=${post._id}" method="post">
                                    <div class="form-group">
                                        <script class="form-group" id="editor" name="backPostContent" type="text/plain" style="width:auto;height:auto;"></script>
                                    </div>
                                    <div class="form-group comment-user">
                                        <input id="btnVCode" type="submit" value="评论" class="pull-right btn btn-primary mg-t-10" />
                                    </div>
                                </form>
                            </div>
                        </header>
