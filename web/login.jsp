...
<div class="container" style="padding-top: 80px">
    ...
    <div class="row row-self page-container">
        <div class="col-md-4 col-md-offset-4">
            ...
            <form name="" id="" action="/users/Login" method="post">
                <div class="form-group ">
                    <label>用户名</label>
                    <input id="tel" name="username" type="text" class="form-control" onblur="" placeholder="用户名">
                    <p id="phoneInfo"></p>
                </div>
                <div class="form-group ">
                    <label for="password">密码</label>
                    <input id="password" name="passwd" type="password" class="form-control" onblur="" id="password"
                           placeholder="密码">
                ...
                <a href="" class="btn btn-info" role="button">注册</a>
            </form>
        </div>
    </div>
